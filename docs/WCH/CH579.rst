...
``Cortex-M0`` ``40MHz`` ``BLE 4.2`` ``USB`` ``Ethernet`` ``10Mbps(PHY)`` ``RTC`` ``AES128`` ``QFN48`` ``QFN28``
`GitHub <https://github.com/SoCXin/CH579>`_ , `官方链接 <http://www.wch.cn/products/CH579.html>`_
...
支持帧过滤，支持 DMA ，内置50Ω匹配电阻 :ref:`eth_phy_tiny`
