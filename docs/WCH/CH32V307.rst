...
`标签 <http://www.wch.cn/products/CH32V307.html>`_ : ``RISC-V`` ``USB-HS-OTG(480Mbps)`` ``Ethernet`` ``10Mbps(PHY)`` ``1Gbps(MAC)`` ``CAN`` ``FSMC`` ``OPA``
...
`STOPs方案:V3-Tool <https://github.com/stops-top/V3-Tool>`_ 用于实现嵌入式边缘网络服务器
