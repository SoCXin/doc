...
* 关键词：``USB`` ``64MHz`` ``BLE5.1`` ``CAN`` ``AES128``
* 资源库：`GitHub <https://github.com/SoCXin/STM32G030>`_
...
相对前代 :ref:`stm32f030` 系列进行了升级，差异可查看 :ref:`st_f0vsg0` ，拥有更好的模拟性能，主频更高同时如CRC等外设全系标配，相对市场同类产品，拥有自家完善的资源体系和可靠性，是新推出的 ``高性价比`` 的国际一线品牌MCU。
