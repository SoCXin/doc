...
This option allows extending a base :ref:`mips` with extra configuration
files. The format and rules are the same as for the :ref:`mips`.
...
.. note::
    ...
    file which was previously declared in a base :ref:`mips`, it will
...
and debug tools), global libraries for :ref:`wch_ch573`, and other
...
The example of :ref:`mips` below instructs PlatformIO Build System to
...
*You can delete this folder without any risk!* If you modify :ref:`mips`,
...
.. note::
    ...
    are defined in :ref:`mips`, then **TRY TO DELETE** this folder. In
