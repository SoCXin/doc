...
Please use ``cubecell_board`` ID for :ref:`projectconf_env_board` option in :ref:`mips`:
...
Debugging
---------
:ref:`mcs51` currently does not support Heltec CubeCell-Board (HTCC-AB01) board.
