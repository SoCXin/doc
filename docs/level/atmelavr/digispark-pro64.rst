...
Please use ``digispark-pro64`` ID for :ref:`projectconf_env_board` option in :ref:`mips`:
...
Debugging
---------
:ref:`mcs51` currently does not support Digispark Pro (16 MHz) (64 byte buffer) board.
