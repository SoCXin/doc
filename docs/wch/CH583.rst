...
* `WCH <http://www.wch.cn/products/CH583>`_ : ``WCH`` ``RISC-V4A`` ``20MHz`` ``USB`` ``AES128`` ``BLE5.1`` ``1.7V`` ``QFN48`` ``QFN28``
* `GitHub <https://github.com/SoCXin/CH583>`_ : :ref:`pop` / :ref:`low` / :ref:`ble` / :ref:`usb`  / :ref:`ulp`
...
`CH582 <https://item.szlcsc.com/3226374.html>`_ 相比 CH583 少了 ``SPI1`` 主机和 512KB 闪存用于存储数据或备份代码，不支持最低 ``1.7V`` 电源电压供电。
