...
Can be customized in :ref:`mips` using :ref:`stm32`
option.
...
Add text transformation. See available filters at :ref:`stm32`.
...
A list of filters that can be applied for monitor output using :option:`pio device monitor --filter` or :ref:`mips` and :ref:`stm32` options.
option.
...
You need to use a ``log2file`` filter from :ref:`stm32`:
...
or using :ref:`mips` and :ref:`stm32`
