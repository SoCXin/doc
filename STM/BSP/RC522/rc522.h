...
u8 SPI1s_ReadWriteByte(u8 TxData);//SPI总线读写一个字节
...
//////////////////////////////////////////////////缓冲区
extern u8 RFID_UID[5]; 										// 数据加密密钥
extern u8 RFID_Buffer[18];								// 射频卡数据缓冲区
extern u8 RFID_Password_Buffer[6]; 				// Mifare One 缺省密码
...
extern void Uart1_SendByte(u8 ch);
